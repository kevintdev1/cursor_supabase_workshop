...
/** All known step IDs — used for runtime validation of persisted data. */
export const WORKSHOP_STEP_IDS = [
  'setup',
  'supabase-project',
  'auth-setup',
  'db-schema',
...
export type WorkshopStepId = (typeof WORKSHOP_STEP_IDS)[number];
    ...
    content: {
      en: `
        <div class="space-y-4">
          ...
          <p class="text-sm text-zinc-500 mt-4">* Provisional content — replace with final workshop instructions</p>
        </div>
      `,
      es: `
        <div class="space-y-4">
          ...
          <p class="text-sm text-zinc-500 mt-4">* Contenido provisional — reemplazar con las instrucciones finales</p>
        </div>
      `,
    },
  },
